 ...
 *
 */
public class GenericKTupleV implements PairFunction <GenericRecord, String, Tuple2<String, GenericRecord>> {
    
    private static final Logger log = Logger.getLogger(GenericKTupleV.class.getName());

    @Override
    public Tuple2<String, Tuple2<String, GenericRecord>> call(GenericRecord record) throws Exception  {
        ...
        return  new Tuple2<String, Tuple2<String, GenericRecord>>(String.valueOf(cal.get(Calendar.YEAR)), new Tuple2<String, GenericRecord>(String.valueOf(cal.get(Calendar.YEAR)), record));
    }
